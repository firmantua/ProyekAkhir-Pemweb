...
if ($email) {
    $query = "SELECT full_name, email, nim, fakultas, jurusan, tahunmasuk, ttl, alamat, nohp 
              FROM mahasiswa 
              WHERE email = '$email'";
...
<body>
    <div class="container mt-5">
        ...
        <div class="card p-3 shadow mb-4">
            ...
            <p><strong>Fakultas:</strong> <?= htmlspecialchars($data['fakultas'] ?? '-'); ?></p>
            <p><strong>Jurusan:</strong> <?= htmlspecialchars($data['jurusan'] ?? '-'); ?></p>
            <p><strong>Tahun Masuk:</strong> <?= htmlspecialchars($data['tahunmasuk'] ?? '-'); ?></p>
