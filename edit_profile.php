...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $tahunmasuk = mysqli_real_escape_string($conn, $_POST['tahun']);
    ...
    <div class="container mt-5">
        ...
        <form action="" method="POST">
            <div class="mb-3">
                ...
                <input type="text" id="fakultas" name="fakultas" value="<?= htmlspecialchars($data['fakultas']); ?>" class="form-control" required>
            </div>
            <div class="mb-3">
                <label for="jurusan" class="form-label">Jurusan</label>
                <input type="text" id="jurusan" name="jurusan" value="<?= htmlspecialchars($data['jurusan']); ?>" class="form-control" required>
            </div>
            <div class="mb-3">
                <label for="tahun" class="form-label">Tahun Masuk</label>
                <select id="tahun" name="tahun" class="form-control" required>
                    <?php
                    // Membuat opsi tahun dari 2000 hingga 2024
                    for ($year = 2000; $year <= 2024; $year++) {
                        $selected = ($year == $data['tahunmasuk']) ? 'selected' : '';
